registerDependency(['map', 'google'], function() {
    ...
    function Marker(options) {
        ...
        if (options.map_icon_label) {
            ...
            this.MarkerLabel.bindTo('visible', this, 'visible');
        }
        (this.MarkerLabel) && this.addListener('visible_changed', function() {
    ...
    MarkerLabel.prototype.draw = function() {
        ...
        var posText = this.get('position');
        if (projection && posText) {
            var position = projection.fromLatLngToDivPixel(posText);
            var div = this.div;
            ...
            div.style.display = (this.get('visible')) ? 'block' : 'none';
